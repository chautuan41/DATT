...
<div class="row">
    <div class="col-md-12">
        <div class="tile">
            <div class="row">
                <div class="col-lg-6">
                    <form method="POST" acction="{{route('update-grade',['id_grade'=>$id_grade])}}">
                        @csrf
                        <div class="form-group">
                            <label for="exampleInputEmail1">Tên Lớp Học</label>
                            <input class="form-control" name="grade_name" type="text" value="{{$dsGrade->grade_name}}" required>
                        </div>
