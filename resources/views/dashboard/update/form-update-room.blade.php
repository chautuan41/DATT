...
<div class="row">
    <div class="col-md-12">
        <div class="tile">
            <div class="row">
                <div class="col-lg-6">
                    <form method="POST" acction="{{route('update-room',['id_room'=>$id_room])}}">
                        @csrf
                        <div class="form-group">
                            <label for="exampleInputEmail1">Tên Phòng Máy</label>
                            <input class="form-control" name="room_name" type="text" value="{{$dsRoom->room_name}}" required>
                        </div>
